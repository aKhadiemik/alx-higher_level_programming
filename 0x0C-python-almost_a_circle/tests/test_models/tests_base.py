...
class TestsBase_cases(unittest.TestCase):
    ...
    def test_no_id(self):
        ...
        base = Base()
        zabe = Base()
        self.assertEqual(base.id, zabe.id - 1)
    ...
    def test_three_bases(self):
        ...
        zabe = Base()
        seba = Base()
        self.assertEqual(base.id, seba.id - 2)
    ...
    def test_id_public(self):
        """
        Verifies that 'id' attribute is correctly set and accessed.
        """
        b = Base(12)
        b.id = 15
    ...
    def test_nb_instances_private(self):
        """
        Verifies that access to '__nb_instances' attribute raises
        an AttributeError.
        """
...
class TestBase_to_json_string(unittest.TestCase):
    """
    Test cases for method to_json_string.
    """
